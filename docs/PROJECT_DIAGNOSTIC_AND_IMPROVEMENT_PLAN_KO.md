...
> 역사적 참고: 이 문서는 v0.5.x 구조를 평가한 진단 snapshot입니다. v0.6.0에서 비루프백 HTTP 인증·CSRF, TCP HMAC·replay 방지와 일회용 client 등록이 구현됐습니다. 현재 보안·검증 계약은 `docs/SECURITY_MODEL.md`와 `docs/VALIDATION_REPORT.md`를 기준으로 판단하세요.
